...
def reset():
    ...
    transcript = "--N/A--"
    comments = "--N/A--"
    return video_id, transcript, comments

def main():
    video_id, transcript, comments = reset()
    ...
    while True:
        ...
        if choice == "1":
            ...
            transcript = get_transcript_summary(transcript, video_id)
        elif choice == "3":
            comments = get_comments(comments, video_id)
        elif choice == "4":
            comments = get_comments_summary(comments, video_id)
        elif choice == "5":
            video_id, transcript, comments = reset()
        elif choice == "6":
            print("Exiting...")
